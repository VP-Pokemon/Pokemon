...
имплементира една од најпознатите три за Nintendo 3DS, а тоа е играта 
Pokemon. Нашата идеа е да претставиме дел од можностите или функционалностите
...
низ мапата при што е овозможена битка помеѓу Pokemoni од различни области,
